...
def main():
    ...
    with st.sidebar:
        ...
        <p style='margin: 0; font-size: 0.9rem;'><strong>👨‍💻 Created by:</strong><br>Jean Baptiste HABINEZA</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        <p>Version 1.0.0</p>
        <p>© 2024 Jean Baptiste HABINEZA</p>
        </div>
        """, unsafe_allow_html=True)
    
    # Main content
    st.markdown("<h1 style='text-align: center;'>Jean Baptiste HABINEZA Data Cleaning & Visualization System</h1>", unsafe_allow_html=True)
